    ...
    <div>
            ...
            <div className='col-md-7 col-lg-6'>
              <div className='d-row d-md-flex justify-content-between align-items-center'>
                <div className='col-12 col-md-6 col-lg-5 md-5 mt-4 my-md-0'>
                  <ul className='footer-navigation list-unstyled mb-00 '>
                    <Link to='/' className='text-decoration-none text-danger' >
                      <li className='text-uppercase fw-semibold'>Asosiy</li>
                    </Link>
                    <Link to='/courses' className='text-decoration-none text-danger' >
                      <li className='text-uppercase fw-semibold'>Bizning kurslar</li>
                    </Link>
                    ...
                    <Link to='/blog' className='text-decoration-none text-danger' >
                      <li className='text-uppercase fw-semibold'>Yangiliklar</li>
                    </Link>
                    <Link to='/contact' className='text-decoration-none text-danger' >
                      <li className='text-uppercase fw-semibold'>Aloqa</li>
                    </Link>
                    <Link to='/tizim' className='text-decoration-none text-danger' >
                      <li className='text-uppercase fw-semibold'>Tizim</li>
                    </Link>
                  </ul>
                </div>
                <div className='col-12 col-md-6 col-lg-7'>
                  <ul className='list-unstyled mb-0'>
                    <li>
                      <p>Manzil - Bulung'ur tumani Mingchinor</p>
                    </li>
                    <li>
                      <p>Telefon nomer - 945380714</p>
                    </li>
                    <li>
                      <p>Email - bulungur@info.com</p>
                    </li>
                  </ul>
                </div>
        ...
        <div className='bg-body-tertiary'>
          <div className='container'>
            <p className='p-3 m-0 text-center'>Dastur uchun aloqa info@gmail.com</p>
          </div>
        </div>
      </footer>
    </div>
